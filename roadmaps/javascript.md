...
3. [Data Types and Variables](#data-types-variables)
4. [Operators and Expressions](#operators-expressions)
5. [Control Flow](#control-flow)
6. [Functions](#functions)
7. [Arrays and Objects](#arrays-objects)
8. [DOM Manipulation](#dom-manipulation)
9. [Events](#events)
10. [Asynchronous JavaScript](#asynchronous-javascript)
11. [Closures and Scope](#closures-scope)
...
16. [Promises and Async/Await](#promises-async-await)
17. [AJAX and Fetch](#ajax-fetch)
